...
import { IGMapSearchInfo, IGMapAddress, IGeocode } from '../../../../_models/g-map.model.';
...
export class GMapSearchComponent implements OnInit,OnChanges {
  ...
  searchGoogleMap() {
    ...
    console.log('keyword', `${operationPositionSearch} ${operationPlaceSearch}`);
  ...
  changeLocation(keyword: string)
  {
    this.gMapService.GetGeoById(keyword)
      .subscribe(data=> {
        ...
        console.log('this.geoLocalisation',this.geoLocalisation);
        ...
        if(this.gMapAddress!=null) {
          ...
          console.log('this.geoLocalisation',this.geoLocalisation);
          console.log('this.data.gMapAddress', this.gMapAddress);
          this.gMapService
            .saveGMapAddress(this.gMapAddress)
            .subscribe(resp=>{
              this.gMapAddress= resp;
              console.log('retour save',resp);
  ...
  parseGeolocalisation() {
    if(this.geoLocalisation.status=='OK')
    {
      ...
      // this.data.gMapAddress.formattedAddress=result.formatted_address;
      // console.log('this.data.gMapAddress.formattedAddress',this.data.gMapAddress.formattedAddress);
