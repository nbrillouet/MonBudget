...
import { IAsifGroupByAccounts } from '../../../../../_models/account-statement-import-file.model';
import { AreaImport, IAccount } from '../../../../../_models/account.model';
...
export class ImportStatementHistoMainComponent implements OnInit, OnDestroy, OnChanges {
  ...
  getUploadResponse($event) {
    ...
    console.log('this.asifAccounts',this.asifAccounts);
