...
import { ChangePlanPosteDetailFilter, PlanPosteDetailChangePlanPosteFrequencies } from 'app/main/_ngxs/plan/plan-detail/plan-poste/plan-poste-detail/plan-poste-detail.action';
...
export class PlanPosteDetailComponent implements OnInit  {
  ...
  constructor(
    ...
    private _dialogRef: MatDialogRef<PlanPosteDetailComponent>,
  ...
  createForms() {
    ...
    this.form.get('isAnnualEstimation').valueChanges.subscribe(isAnnualEstimation => {
  ...
  save({ value, valid }: { value: any, valid: boolean }) {
    ...
    this._planPosteService.savePlanPosteDetail(this.data)
  ...
  onReferenceChange(value) {
    ...
    this._planPosteService.GetPlanPosteReferenceByIdReferenceTable(planPosteReferenceFilter).subscribe(x=>{
