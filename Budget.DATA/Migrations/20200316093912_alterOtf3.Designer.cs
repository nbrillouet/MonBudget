...
namespace Budget.DATA.Migrations
{
    ...
    [Migration("20200316093912_alterOtf3")]
    partial class alterOtf3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Budget.MODEL.Database.Assert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Budget.MODEL.Database.OperationTypeFamily", b =>
                {
                    ...
                    b.Property<int>("IdAssert")
                        .HasColumnName("ID_ASSERT");
            ...
            modelBuilder.Entity("Budget.MODEL.Database.OperationTypeFamily", b =>
                {
                    b.HasOne("Budget.MODEL.Database.Assert", "Assert")
                        .WithMany()
                        .HasForeignKey("IdAssert")
                        .OnDelete(DeleteBehavior.Cascade);
